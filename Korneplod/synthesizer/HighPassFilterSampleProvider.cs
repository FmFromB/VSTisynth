...
namespace synthesizer
{
    public class HighPassFilterSampleProvider : ISampleProvider
    {
        ...
        public HighPassFilterSampleProvider(ISampleProvider sourse, int cutOffFrequency = 1500, float q = 0.7f)
        {
            _sourse = sourse;
            _filter = BiQuadFilter.HighPassFilter(_sourse.WaveFormat.SampleRate, cutOffFrequency, q);
        }
